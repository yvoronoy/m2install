...
assertContains "$CURRENT" "install, [0,2]00, http://${CURRENT_DIR_NAME}.127.0.0.1.nip.io/, [0,2,3]0[0,2], http://${CURRENT_DIR_NAME}.127.0.0.1.nip.io/admin, [0-9]*, $(whoami), $(pwd), $BIN_M2INSTALL, \"--force --source composer -v 2.3.5\"" "CSV File row is not match"
